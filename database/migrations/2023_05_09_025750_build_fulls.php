...
return new class extends Migration
{
    ...
    {   
        Schema::create('build_fulls', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('monitor_image')->nullable();
            $table->integer('mouse_id')->nullable();
            $table->string('mouse_image')->nullable();
            $table->integer('headset_id')->nullable();
            $table->string('headset_image')->nullable();
            $table->integer('keyboard_id')->nullable();
            $table->string('keyboard_image')->nullable();
    ...
    {
        Schema::dropIfExists('build_fulls');
    }
};

...
<body class="flex flex-col h-screen justify-between">
    ...
    <x-content class="md:pb-20 md:px-20 pb-16 px-auto">
        <form action="{{ route('admin.finder.unit.process') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-3 w-full h-full mt-10">
                ...
                <div class="">
                    <div class="flex justify-start items-center">
                        <h1 class="text-5xl text-orange-800 font-bold">Computer Finder (System Unit)</h1>
                    </div>
                    <div class="grid grid-rows-12 gap-5 mt-10">
                        ...
                        <div>
                            <label class="text-lg text-orange-800 font-bold" for="case_fan_id">Case Fan</label>
                            <input class="w-full h-auto border border-black mt-2" type="text" name="case_fan_id" id="case_fan_id" value="{{ old('case_fan_id') }}">
                            @error('case_fan_id')
                                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                            @enderror
                        </div>
                ...
                <div class="p-10">
                    ...
                    <div class="mt-6">
                        ...
                        <label class="text-lg text-orange-800 font-bold" for="brand">Aesthetic</label>
                        <select name="aesthetic" class="w-full h-auto border border-black mt-2 mb-4">
                    ...
                    <div class="flex items-center justify-center gap-4">
                        <div class="mt-8">
                            <input class="w-full h-auto border border-black mt-2" type="hidden" name="category" id="category" value="unit">
                        </div>
                    </div>
                </div>
            </div>

...
<body class="flex flex-col h-screen justify-between">
    ...
    <div class="flex items-center justify-center mt-16">
        <h1 class="text-5xl text-orange-800 font-bold">FULL SET-UP FINDER</h1>
    </div>
    <x-content class="md:pb-20 md:px-20 pb-16 px-auto">
        <form class="p-14" action="{{ route('user.filter.finder.full') }}" method="GET">
            <div class="border border-black flex justify-center items-center p-10">
                <div class="grid grid-rows-6 gap-10">
                    ...
                    <div class="">
                        ...
                        <select name="peripherals" class="w-full h-auto border border-black mt-5">
